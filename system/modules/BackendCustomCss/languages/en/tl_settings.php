...
$GLOBALS['TL_LANG']['tl_settings']['backendCustomCssSystemStylesDescription'] = array('Description', 'Enter a description for this CSS file. This will be used in the wizard in the user settings.');
